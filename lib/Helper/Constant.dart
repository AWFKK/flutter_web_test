...
class APIS {
  ...
  static var checkNumber = baseurl + "checknumber";
  static var postCode = baseurl + "postcode";
  static var imageUpdate = baseurl + "imageUpload";
  static var updateUserName = baseurl + "updateUserName";
  static var getCardList = baseurl + "get_user_paymentMethods";      // Card List Data Here
  static var saveNewCard = baseurl + "add_user_card";      // Card List Data Here
  static var promoCodeDetail = baseurl + "promocode_details";      // Card List Data Here
  static var listOfPromotions = baseurl + "promotion_list";      // Card List Data Here
  static var calculateEta = baseurl + "calculateEtaFromGoogle";      // Card List Data Here
  static var deleteUserCard = baseurl + "delete_user_card";      // Card List Data Here
  static var getStripeKey = baseurl + "get_settings";      // Card List Data Here
  ...
  static var allTopRestaurant = baseurl + "all_top_shops";
  static var mostPopularRestaurant = baseurl + "most_polupar_shops";
  ...
  static var addRestaurantReview = baseurl + "add_shop_review";
  ...
  static var getCategoryList = baseurl + "categories"; //For Category
  static var getShopCategoryList = baseurl + "shopcategories";
  ...
  static var checkPromocode = baseurl + "apply_promocode";
  ...
  static var getTimeZone =
      baseurl + 'timeZoneList/'; //0 for tomorrow, // 1/14:20 for today
  static var cartCount = baseurl + 'cartCount';
  static var allTopShop = baseurl + 'all_top_shops';
}
...
class Keys {
  ...
  static var merchantID = "merchant.com.instadoor.customerapp";
  static var razorPayId = 'rzp_test_XDtOe2jFc';
...
class AppColor {
  static var background = hexToColor("#efeaea");
  static var themeColor = hexToColor("#7445d1");
  static var newthemeColorLogo = hexToColor("#24cdc4");
  static var newSubCategoryBarColor = hexToColor("#e8ede7");
  static var newCategoryBarColor = hexToColor("#7b4ed4");
  ...
  static var amberCustom = HexToColor("#daae2b");
}
...
class AppImages {
  static var appLogo = "Assets/Grocery/instadoor_logo.png";
  //static var appLogo = "Assets/Grocery/GrocEasy_512.png";
  ...
  static var groceryProduct = 'Assets/Grocery/groceryProduct.png';
}
